(() => {
    ...
    const end = new Date("Oct 16, 2020 00:00:00").getTime();
    ...
    const int = setInterval(() => {
        ...
        if (remaining < 0) {
            document.querySelector("h1").innerText = "34. Tanışma Ayımız Kutlu Olsun";
            document.querySelector("p").innerHTML = "Ferhat Hatırlama Skorlarında 4-3 Öne Geçiyor";
